...
import * as sam from "./superheroes/sam/src/extension.js";
...
export function activate(context: vscode.ExtensionContext) {
  ...
  const wakeUp = vscode.commands.registerCommand(
    "ai4sd-helpers.wakeup",
    () => {}
  );
...
export function deactivate() {
  whattheduck.deactivate();
  easycomment.deactivate();
  sam.deactivate();
}
