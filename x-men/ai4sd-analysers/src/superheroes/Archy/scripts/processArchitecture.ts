import { fetchCommitLogsFromWorkspace } from './fetchCommitLogs.js';
...
export async function processArchitecture( includeCommits: boolean, includeDocumentation: boolean, language: string ): Promise<string> {
 ...
 */
async function zipDirectory(sourceDir: string, outPath: string, includeDocumentation: boolean, commitsFilePath: string): Promise<void> {
...
async function sendZipToBackend(zipFilePath: string, language: string): Promise<string> {
