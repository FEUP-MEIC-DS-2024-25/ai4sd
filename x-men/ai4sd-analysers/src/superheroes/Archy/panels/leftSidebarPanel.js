...
export class LeftSidebarPanel {
    ...
    _getHtmlForWebview(webview, extensionUri, recentRequests) {
        const webviewUri = getUri(webview, extensionUri, ["out", "webview.js"]);
        const languagesJsonUri = webview.asWebviewUri(vscode.Uri.joinPath(extensionUri, "src", "assets", "languages.json"));
