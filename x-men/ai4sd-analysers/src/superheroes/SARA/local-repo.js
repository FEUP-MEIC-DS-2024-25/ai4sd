...
export async function analyzeLocal(llm) {
    const markdownFilePath = path.join(__dirname, "local_architectural_patterns.md");
...
function zip_local_files(workspacePath) {
