...
import AssistantButton from "../components/assistantButton.js";
        ...
        <main className={styles.main} style={{ color: "none" }}>
            ...
            <div className="container" style={{ minWidth: "100%", display: 'flex', flexDirection: "column", alignItems: "center", background: "linear-gradient(180deg, rgba(20,20,20,1) 8%, rgba(44,44,44,1) 100%);" }} >
                ...
                <div className="row" style={{ marginBottom: 30 + 'px' }}>
                    <span style={{ fontSize: 28 + "px", textAlign: "center", color: "white" }}>
                        Artificial Intelligence for <br /> Software Development
                    </span>
                </div>
            </div>

            <div className="container" style={{ display: "grid", gap: "15px", padding: "20px 30px 20px 30px", gridTemplateColumns: "repeat(3, 1fr)", backgroundColor: "white", height: "400px", minWidth: "100%" }}>
            ...
            <div className="container" style={{ backgroundColor: "#EFEFEF", minWidth: "100%", minHeight: "650px" }}>
                <div className="row" id="filterControls" style={{ marginLeft: "120px", marginTop: "30px", marginBottom: "65px", display: "grid", gridTemplateColumns: "80px repeat(4, 165px)", gap: "15px", alignContent: "center", justifyItems: "start" }}>
                    <span style={{ color: "#636363", fontSize: "28px", margin: "0px" }}>Filter</span>
