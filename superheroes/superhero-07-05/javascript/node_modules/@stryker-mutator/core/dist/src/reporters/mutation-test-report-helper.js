...
export class MutationTestReportHelper {
    ...
    fs;
    requireFromCwd;
    static inject = tokens(coreTokens.reporter, commonTokens.options, coreTokens.project, commonTokens.logger, coreTokens.testCoverage, coreTokens.fs, coreTokens.requireFromCwd);
