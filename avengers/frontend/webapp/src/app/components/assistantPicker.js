...
function getAssistantList() {
    ...
    let ai_c06_t04 = { name: "PatternPartner", type: "arch", link: "/assistants/patternpartner" };
  
    return [ai1, ai2, ai3, ai4, ai5, ai6, ai7, ai8, ai9, ai10, ai11, ai12, ai13, ai14, ai_c06_t04]
}
